...
//	MochiKit.Base.bindMethods(this);
	...
	this._maxStackLengthBeforeHashing = args.maxStackLengthBeforeHashing || 33;
	return this;
}
...
Clipperz.Crypto.PRNG.MouseRandomnessSource = function(args) {
	...
	MochiKit.Signal.connect(document, 'ontouchstart', this, 'collectEntropy');
	MochiKit.Signal.connect(document, 'ontouchmove', this, 'collectEntropy');
...
Clipperz.Crypto.PRNG.KeyboardRandomnessSource = function(args) {
	...
	MochiKit.Signal.connect(document, 'onkeydown', this, 'collectEntropy');
...
Clipperz.Crypto.PRNG.KeyboardRandomnessSource.prototype = MochiKit.Base.update(new Clipperz.Crypto.PRNG.RandomnessSource, {
	...
	'collectEntropy': function(anEvent) {
		var bt = anEvent.which ^ new Date().getTime();
		
		var mask = 0xffffffff >>> (32 - this.numberOfBitsToCollectAtEachEvent());
		this.appendRandomBitsToRandomBitsCollector(bt & mask);
	},
